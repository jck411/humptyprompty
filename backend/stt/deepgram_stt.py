...
class DeepgramSTTProvider(BaseSTTProvider):
    def __init__(self, config):
        ...
        # Use the singleton PyAudio instance instead of creating a new one
        self._pyaudio = PyAudioSingleton()
    ...
    def _stop_listening_impl(self) -> None:
        ...
        # Don't terminate PyAudio - we're using the singleton instance
